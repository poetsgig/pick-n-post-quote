...
Utilizes the native WordPress custom field on version 5.0+. Guttenberg editor does not currently support WP custom field. While WP supports custom field display on posts page by default, Pick-n-Post Quote plugin allows you to display a static quote of the current post in sidebar area. Displaying quote author and source is optional.
